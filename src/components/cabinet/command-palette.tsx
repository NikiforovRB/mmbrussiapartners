...
const ITEMS: Item[] = [
  { id: "d-dash", label: "Дашборд (дилер)", href: "/dealer", icon: <LayoutDashboard className="h-4 w-4" />, scope: "dealer" },
  { id: "d-licenses", label: "Мои лицензии", href: "/dealer/licenses", icon: <KeyRound className="h-4 w-4" />, scope: "dealer" },
  { id: "d-new", label: "Новая лицензия", href: "/dealer/licenses/new", icon: <Plus className="h-4 w-4" />, scope: "dealer", keywords: ["create", "device"] },
  { id: "d-payments", label: "Платежи", href: "/dealer/payments", icon: <CreditCard className="h-4 w-4" />, scope: "dealer" },
  { id: "d-reports", label: "Отчёты", href: "/dealer/reports", icon: <FileSpreadsheet className="h-4 w-4" />, scope: "dealer" },
  ...
  { id: "a-payments", label: "Платежи", href: "/admin/payments", icon: <CreditCard className="h-4 w-4" />, scope: "admin" },
  { id: "a-audit", label: "Аудит", href: "/admin/audit", icon: <History className="h-4 w-4" />, scope: "admin" },
  { id: "a-settings", label: "Настройки", href: "/admin/settings", icon: <Settings className="h-4 w-4" />, scope: "admin" },
];
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 rounded-panel bg-card-light px-4 h-12">
              ...
              />
              <span className="text-[10px] uppercase tracking-tight text-ink-subtle">Esc</span>
            </div>
            <ul className="mt-2 max-h-[50vh] overflow-auto scrollbar-clean">
              ...
              {items.length === 0 ? (
                <li className="px-3 py-6 text-sm text-ink-muted text-center">Ничего не найдено</li>
              ) : null}
            </ul>
