      ...
      <div className="space-y-1.5">
        ...
        {!configured ? (
          ...
          <p className="text-xs text-ink-subtle">
            Пароль задан до появления этой функции и хранится только в виде хэша. Задайте новый — и он будет виден
            здесь. Представитель также может сменить его в профиле.
          </p>
        ) : (
